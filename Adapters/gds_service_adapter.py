...
class GDSServiceAdapterMock:
    ...
    def parse_priced_itinerary(priced_itinerary):
        ...
        result.Segments = list(map(GDSServiceAdapterMock.parse_itinerary, priced_itinerary['AirItinerary']['OriginDestinationOptions']['OriginDestinationOption']))
